...
export default function UsdropElite() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow">
        {/* Hero / Offer Section */}
        <section className="bg-gradient-to-b from-amber-50 to-background pt-14 pb-16 md:pt-20 md:pb-24">
          <div className="container mx-auto px-4 md:px-6 max-w-3xl text-center">
            {/* Most Popular Badge */}
            <div className="flex justify-center mb-4">
              <span className="bg-amber-100 text-amber-700 border border-amber-200 rounded-full px-4 py-1 text-sm font-semibold">
                Most Popular
              </span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight mb-4">
              Everything You Need to Sell in the US. Done for You.
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl mx-auto">
              The complete US business setup — LLC, EIN, bank account, Amazon seller account, and more. Built for serious USDrop sellers.
            </p>

            {/* Price Block */}
            <div className="inline-flex flex-col items-center bg-card border border-amber-200 rounded-2xl px-8 py-6 shadow-md mb-8">
              <div className="flex items-baseline gap-3 mb-1">
                <span className="text-xl text-muted-foreground line-through">₹99,000</span>
                <span className="text-4xl font-bold text-primary">₹69,000</span>
              </div>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6 max-w-3xl">
            <div className="text-center mb-6">
              <Link href="/usdrop-llc" className="text-primary hover:underline font-medium text-sm">
                Need just the basics? Just LLC starts at ₹39,000 →
              </Link>
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">Everything's Included</h2>
            <div className="bg-card border border-border rounded-2xl p-6 md:p-8">
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  { text: "LLC Formation (Wyoming or Delaware)" },
                  { text: "EIN (Employer Identification Number) from IRS" },
                  { text: "Articles of Organization filed & approved" },
                  { text: "Operating Agreement (e-commerce optimized)" },
                  { text: "Registered Agent — 1st year free" },
                  { text: "Annual compliance reminders" },
                  { text: "US Mailing Address" },
                  { text: "US Phone Number" },
                  { text: "US Bank Account Setup (Mercury or Relay)" },
                  { text: "ITIN Application Assistance" },
                  { text: "Resale Certificate Filing" },
                  { text: "Amazon Seller Account Setup" },
                  { text: "Shopify Website Development", badge: "NEW" },
                  ...
                  <div key={text} className="flex items-start gap-2.5 text-sm">
                    ...
                    <span>
                      {text}
                      {badge && (
                        <span className="ml-2 bg-amber-100 text-amber-700 border border-amber-200 rounded-full px-2 py-0.5 text-xs font-semibold">
                          {badge}
                        </span>
                      )}
                    </span>
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-3xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                { icon: "✅", step: "3", title: "Full Setup Complete", desc: "You receive all documents, bank access, and seller account details within 48–72 hrs." },
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-md">
            <div className="bg-white rounded-2xl shadow-md p-8">
              {submitted ? (
                ...
                <>
                  <h2 className="text-xl font-bold mb-1 text-foreground">Claim Your Elite Package</h2>
                  <p className="text-sm text-muted-foreground mb-6">₹69,000 total · USDROP30 applied</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <input type="hidden" name="package" value="elite-llc" />
                    ...
                    >
                      {submitting ? "Submitting..." : "Get Elite Package — ₹69,000"}
                    </Button>
                  </form>
                </>
              )}
